...
data=nib.load(ses1LR).get_fdata()

print('single session no normalization test of corrMat')
print('running left corrmat')
rmat=np.corrcoef(data[lcort])
print(rmat.shape)
del rmat

print('running right corrmat')
rmat=np.corrcoef(data[rcort])
print(rmat.shape)
del rmat


print('running full corrmat')
